...
new Vue({
  ...
  data: {
    ...
    notifications: [
        { id: 1, title: 'article 1', date: '24 Jan', time:'7:01 pm', description: 'The deadline for submitting expenses is this Friday 11th October.' },
        { id: 2, title: 'article 2', date: '28 Jan', time:'10:00 am', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
        { id: 3, title: 'article 3', date: '1 Feb', time:'1:00 pm', description: 'Donec suscipit, nisi non venenatis venenatis.' },
        { id: 4,  title: 'article 4', date: '14 Feb', time:'9:00 am', description: 'Donec bibendum massa a eros dignissim, non commodo lacus sollicitudin.' },
        { id: 5, title: 'article 5', date: '18 Feb', time:'3:30 pm', description: 'Pellentesque eu venenatis nunc, Curabitur ac risus.' },
        { id: 6, title: 'article 6', date: '24 Feb', time:'5:14 pm', description: 'Cras a auctor veli, Aenean lacinia auctor metus.' }    
]
},
// mounted() {
